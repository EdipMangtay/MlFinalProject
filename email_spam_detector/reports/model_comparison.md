...
- Across the training set, SVM achieved the highest Accuracy (0.98), Precision (1.00), Recall (0.99), F1-Score (0.99), and AUC (1.00).
- On the testing set, SVM achieved the highest Accuracy (0.98) and F1-Score (0.94), while other models may have achieved higher Precision or Recall in some cases.
